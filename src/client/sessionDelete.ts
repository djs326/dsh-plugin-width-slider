...
export function sessionInfoFromRow(row: HTMLElement): { sessionId: string; running: boolean } | null {
  if (!row) return null
...
export function findOpenSessionRow(): HTMLElement | null {
...
export function rowTitleOf(row: HTMLElement): string {
