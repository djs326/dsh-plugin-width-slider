...
const TABS_CSS = `
[data-dsh-ws-tabs-bar]{display:flex;align-items:center;gap:2px;flex:0 1 auto;min-width:0;max-width:62%;height:100%;overflow-x:auto;overflow-y:hidden;padding-left:2px;scrollbar-width:none;order:-1}
